...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>secant.lisp at master from pedrosans/computational_mathematics - GitHub</title>
...
<meta content="75f5792e0d1578db9eb3edaff48052cb33967218" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundle_github.js?88c2b5bccd6a2a3b368f3ed58fe6fcf0582e5ca6" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/pedrosans/computational_mathematics/blob/e471c1bf0c0c8db7d6b63675658a161389317a47/secant.lisp'>
  ...
  <body class="logged_out page-blob windows env-production ">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="https://github.com/login?return_to=%2Fpedrosans%2Fcomputational_mathematics%2Fblob%2Fmaster%2Fsecant.lisp">Login</a></li>
    </ul>
</div>
            ...
            <div class="body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/pedrosans/computational_mathematics/blob/master/secant.lisp" data-name="master">master</a>
                  </h4>
                </div>
...
<div class="commit commit-tease js-details-container">
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="secant.lisp/">
      <b><a href="/pedrosans/computational_mathematics/tree/e471c1bf0c0c8db7d6b63675658a161389317a47" class="js-rewrite-sha">computational_mathematics</a></b> / secant.lisp       <span style="display:none" id="clippy_3434" class="clippy-text">secant.lisp</span>
      ...
      <param NAME="FlashVars" value="id=clippy_3434&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             ...
             FlashVars="id=clippy_3434&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="secant.lisp/" data-permalink-url="/pedrosans/computational_mathematics/blob/e471c1bf0c0c8db7d6b63675658a161389317a47/secant.lisp" data-title="secant.lisp at master from pedrosans/computational_mathematics - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/pedrosans/computational_mathematics/edit/e471c1bf0c0c8db7d6b63675658a161389317a47/secant.lisp" data-method="post"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/pedrosans/computational_mathematics/raw/master/secant.lisp" id="raw-url">raw</a></li>
                  <li><a href="/pedrosans/computational_mathematics/blame/master/secant.lisp">blame</a></li>
                <li><a href="/pedrosans/computational_mathematics/commits/master/secant.lisp">history</a></li>
              </ul>
            </div>
...
<span id="L38" rel="#L38">38</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">;;    secant.lisp - find root for given function</span></div><div class='line' id='LC2'><span class="c1">;;    Copyright (C) 2011 Pedro Henrique Oliveira dos Santos</span></div><div class='line' id='LC3'><span class="c1">;;</span></div><div class='line' id='LC4'><span class="c1">;;    This program is free software: you can redistribute it and/or modify</span></div><div class='line' id='LC5'><span class="c1">;;    it under the terms of the GNU General Public License as published by</span></div><div class='line' id='LC6'><span class="c1">;;    the Free Software Foundation, either version 3 of the License, or</span></div><div class='line' id='LC7'><span class="c1">;;    (at your option) any later version.</span></div><div class='line' id='LC8'><span class="c1">;;</span></div><div class='line' id='LC9'><span class="c1">;;    This program is distributed in the hope that it will be useful,</span></div><div class='line' id='LC10'><span class="c1">;;    but WITHOUT ANY WARRANTY; without even the implied warranty of</span></div><div class='line' id='LC11'><span class="c1">;;    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the</span></div><div class='line' id='LC12'><span class="c1">;;    GNU General Public License for more details.</span></div><div class='line' id='LC13'><span class="c1">;;</span></div><div class='line' id='LC14'><span class="c1">;;    You should have received a copy of the GNU General Public License</span></div><div class='line' id='LC15'><span class="c1">;;    along with this program.  If not, see &lt;http://www.gnu.org/licenses/&gt;.</span></div><div class='line' id='LC16'><span class="c1">;;</span></div><div class='line' id='LC17'><span class="c1">;;    Contact: pedrosans at gmail dot com</span></div><div class='line' id='LC18'><span class="c1">;;</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><span class="p">(</span><span class="nb">defun</span> <span class="nv">secant</span><span class="p">(</span><span class="nv">f</span> <span class="nv">a</span> <span class="nv">b</span> <span class="nv">precisao</span> <span class="nv">interacoes</span><span class="p">)</span></div><div class='line' id='LC21'>	<span class="p">(</span><span class="k">if</span> <span class="p">(</span><span class="nb">eq</span> <span class="nv">interacoes</span> <span class="mi">0</span><span class="p">)</span> </div><div class='line' id='LC22'>		<span class="nv">a</span></div><div class='line' id='LC23'>		<span class="p">(</span><span class="k">progn</span> </div><div class='line' id='LC24'>			<span class="p">(</span><span class="k">setq</span> <span class="nv">sombra</span> <span class="p">(</span><span class="nv">f</span> <span class="nv">a</span><span class="p">))</span></div><div class='line' id='LC25'>			<span class="p">(</span><span class="nb">format</span> <span class="no">t</span> <span class="s">&quot;~,10F	~,10F	~,10F ~D ~%&quot;</span> <span class="nv">a</span> <span class="nv">b</span> <span class="nv">sombra</span> <span class="nv">interacoes</span><span class="p">)</span></div><div class='line' id='LC26'>			<span class="p">(</span><span class="k">if</span> <span class="p">(</span><span class="nb">and</span> <span class="p">(</span><span class="nb">&lt;</span> <span class="nv">sombra</span> <span class="nv">precisao</span><span class="p">)</span> <span class="p">(</span><span class="nb">&gt;</span> <span class="nv">sombra</span> <span class="p">(</span><span class="nb">*</span> <span class="nv">precisao</span> <span class="mi">-1</span><span class="p">)))</span></div><div class='line' id='LC27'>				<span class="p">(</span><span class="k">progn</span> <span class="p">(</span><span class="nb">print</span> <span class="s">&quot;precisao alcancada&quot;</span><span class="p">)</span> <span class="nv">chute</span> <span class="p">)</span></div><div class='line' id='LC28'>				<span class="p">(</span><span class="k">progn</span> </div><div class='line' id='LC29'>					<span class="p">(</span><span class="k">setq</span> <span class="nv">chute</span> <span class="p">(</span><span class="nb">/</span><span class="p">(</span><span class="nb">-</span><span class="p">(</span><span class="nb">*</span><span class="p">(</span><span class="nb">read-from-string</span> <span class="p">(</span><span class="nb">format</span> <span class="no">NIL</span> <span class="s">&quot;~20,20F&quot;</span> <span class="nv">a</span><span class="p">))(</span><span class="nb">funcall</span> <span class="nv">f</span> <span class="nv">b</span><span class="p">))</span> <span class="p">(</span><span class="nb">*</span> <span class="nv">b</span> <span class="p">(</span><span class="nb">funcall</span> <span class="nv">f</span> <span class="nv">a</span><span class="p">)))(</span><span class="nb">-</span><span class="p">(</span><span class="nb">funcall</span> <span class="nv">f</span> <span class="nv">b</span><span class="p">)(</span><span class="nb">funcall</span> <span class="nv">f</span> <span class="nv">a</span><span class="p">)))</span> <span class="p">)</span></div><div class='line' id='LC30'>					<span class="p">(</span><span class="nv">secant</span> <span class="nv">f</span> <span class="nv">b</span> <span class="nv">chute</span> <span class="nv">precisao</span> <span class="p">(</span><span class="nb">-</span> <span class="nv">interacoes</span> <span class="mi">1</span><span class="p">))</span></div><div class='line' id='LC31'>				<span class="p">)</span></div><div class='line' id='LC32'>			<span class="p">)</span></div><div class='line' id='LC33'>		<span class="p">)</span></div><div class='line' id='LC34'>	<span class="p">)</span></div><div class='line' id='LC35'><span class="p">)</span></div><div class='line' id='LC36'><span class="c1">;exemplo de utilização</span></div><div class='line' id='LC37'><span class="c1">;(defun f(x)(+ (* x x x) (* x x -1) (* -12 x ) ))</span></div><div class='line' id='LC38'><span class="c1">;(print (secant #&#39;f 2 3 0.00001 20 ))</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="site" class="clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2011 <span id="_rrt" title="0.17525s from fe8.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
